    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-neutral-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-neutral-900 mb-4">About SwitchBoard</h1>
        ...
        <Card className="mb-8 border-neutral-200">
          ...
          <CardContent className="space-y-4">
            <p className="text-neutral-700 leading-relaxed">
              SwitchBoard is dedicated to building the world's most comprehensive, community-driven corpus of
