...
export default function DashboardPage() {
  ...
  const mockLanguagePairData: LanguagePairStats[] = [
    { pair: "English-Spanish", count: 3420, fill: "hsl(var(--chart-1))" },
    { pair: "English-Hindi", count: 2890, fill: "hsl(var(--chart-2))" },
    { pair: "English-Mandarin", count: 2340, fill: "hsl(var(--chart-3))" },
    { pair: "English-French", count: 1980, fill: "hsl(var(--chart-4))" },
    { pair: "Spanish-English", count: 1750, fill: "hsl(var(--chart-5))" },
  ]

  const mockSwitchPointData: SwitchPointData[] = [
  ...
  const mockPlatformData: PlatformStats[] = [
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const metricsData = await fetchDashboardMetrics() // This already returns mock data
      const languagePairs = mockLanguagePairData
      const switchPoints = mockSwitchPointData
